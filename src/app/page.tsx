    ...
    <main className="2xl:ml-[--w-side] xl:ml-[--w-side-md] md:ml-[--w-side-small]">
        <div className="main__inner">
            ...
            <div>
                ...
                <div className="relative" uk-slider="autoplay: true;finite: true" uk-lightbox="">
                    ...
                    <div className="max-md:hidden">
                        ...
                        <button type="button" className="absolute -translate-y-1/2 bg-white shadow rounded-full top-1/2 -left-3.5 grid w-8 h-8 place-items-center dark:bg-dark3" uk-slider-item="previous"> <IoChevronBack className="text-2xl"/></button>
                        <button type="button" className="absolute -right-2 -translate-y-1/2 bg-white shadow rounded-full top-1/2 grid w-8 h-8 place-items-center dark:bg-dark3" uk-slider-item="next"> <IoChevronForward name="chevron-forward" className="text-2xl"/> </button>
                ...
                <div className="md:max-w-[510px] mx-auto flex-1 xl:space-y-6 space-y-3">
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-4 space-y-4 text-sm font-medium border1 dark:bg-dark2">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="p-2 bg-sky-100 hover:bg-opacity-80 transition-all rounded-lg cursor-pointer" uk-toggle="target: #create-status">
                            ...
                            <div className="p-2 bg-pink-100 hover:bg-opacity-80 transition-all rounded-lg cursor-pointer" uk-toggle="target: #create-status">
                    ...
                    <div className="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                        ...
                        <div className="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
                            <a href="profile.html"> <img src="assets/images/avatars/avatar-3.jpg" alt="" className="w-9 h-9 rounded-full"/> </a>  
                            <div className="flex-1">
                                <a href="profile.html"> <h4 className="text-black dark:text-white"> Monroe Parker </h4> </a>  
                        ...
                        <div className="relative w-full lg:h-72 h-full sm:px-4">
                            <img src="assets/images/avatars/avatar-lg-4.jpg" alt="" className="sm:rounded-lg w-full h-full object-cover"/>
                        </div>
                        ...
                        <div className="sm:p-4 p-2.5 flex items-center gap-4 text-xs font-semibold">
                            ...
                            <div className="flex items-center gap-3">
                                <button type="button" className="button__ico bg-slate-200/70 dark:bg-slate-700"> 
                                  ...
                                  <IoChatbubbleEllipses className="text-lg" name="chatbubble-ellipses"/>
                                </button>
                                <span>260</span>
                            </div>
                        ...
                        <div className="sm:p-4 p-2.5 border-t border-gray-100 font-normal space-y-3 relative dark:border-slate-700/40"> 
                            ...
                            <div className="flex items-start gap-3 relative">
                                <a href="profile.html"> <img src="assets/images/avatars/avatar-2.jpg" alt="" className="w-6 h-6 mt-1 rounded-full"/> </a>
                                <div className="flex-1">
                                    <a href="profile.html" className="text-black font-medium inline-block dark:text-white"> Steeve </a>
                                    <p className="mt-0.5">What a beautiful photo! I love it. 😍 </p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3 relative">
                                <a href="profile.html"> <img src="assets/images/avatars/avatar-3.jpg" alt="" className="w-6 h-6 mt-1 rounded-full"/> </a>
                                <div className="flex-1">
                                    <a href="profile.html" className="text-black font-medium inline-block dark:text-white"> Monroe </a>
                    ...
                    <div className="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                        ...
                        <div className="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
                            <a href="profile.html"> <img src="assets/images/avatars/avatar-2.jpg" alt="" className="w-9 h-9 rounded-full"/> </a>
                            <div className="flex-1">
                                <a href="profile.html"> <h4 className="text-black dark:text-white"> Martin Gray </h4> </a>
                                <div className="text-xs text-gray-500 dark:text-white/80"> 2 hours ago</div>
                            </div>
                        ...
                        <div className="relative uk-visible-toggle sm:px-4" uk-slideshow="animation: push;finite: true;min-height: 200; max-height: 250">
                            ...
                            <ul className="uk-slideshow-items" uk-lightbox=""> 
                                <li className="w-full overflow-hidden sm:rounded-md">
                                    <a href="assets/images/avatars/avatar-lg-3.jpg"  data-caption="Caption">
                                        <img src="assets/images/avatars/avatar-lg-2.jpg" className="w-full h-full object-cover inset-0" alt=""/>
                                    </a>
                                </li>
                                <li className="w-full overflow-hidden sm:rounded-md">
                                    <a href="assets/images/avatars/avatar-lg-3.jpg"  data-caption="Caption">
                                        <img src="assets/images/avatars/avatar-lg-3.jpg" className="w-full h-full object-cover inset-0" alt=""/>
                                    </a>
                                </li>
                            ...
                            <button type="button" className="absolute left-2 -translate-y-1/2 bg-black/40 backdrop-blur-3xl rounded-full top-1/2 grid w-7 h-7 place-items-center shadow" uk-slideshow-item="previous"> 
                              <IoChevronBack className="text-xl text-white"/>
                            </button>
                            <button type="button" className="absolute right-2 -translate-y-1/2 bg-black/40 backdrop-blur-3xl rounded-full top-1/2 grid w-7 h-7 place-items-center shadow" uk-slideshow-item="next"> 
                    ...
                    <div className="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
                        ...
                        <div className="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
                            <a href="profile.html"> <img src="assets/images/avatars/avatar-5.jpg" alt="" className="w-9 h-9 rounded-full"/> </a> 
                            <div className="flex-1">
                                <a href="profile.html"> <h4 className="text-black dark:text-white"> John Michael </h4> </a> 
                                <div className="text-xs text-gray-500 dark:text-white/80"> 2 hours ago</div>
                            </div>
                        ...
                        <div className="sm:p-4 p-2.5 border-t border-gray-100 font-normal space-y-3 relative dark:border-slate-700/40"> 
                            ...
                            <div className="flex items-start gap-3 relative">
                                <a href="profile.html"> <img src="assets/images/avatars/avatar-5.jpg" alt="" className="w-6 h-6 mt-1 rounded-full"/> </a>
                                <div className="flex-1">
                                    <a href="profile.html" className="text-black font-medium inline-block dark:text-white"> Jesse </a>
                ...
                <div className="lg:max-w-[370px] md:max-w-[510px] mx-auto">
                    ...
                    <div className="xl:space-y-6 space-y-3 md:pb-12"  uk-sticky="end: #js-oversized; offset: 50; media:992">
                        ...
                        <div className="bg-white rounded-xl shadow-sm p-5 px-6 border1 dark:bg-dark2">
                            ...
                            <div className="space-y-4 capitalize text-xs font-normal mt-5 mb-2 text-gray-500 dark:text-white/80">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                        <a href="profile.html"><h4 className="font-semibold text-sm text-black dark:text-white">  Johnson smith</h4></a>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                        <a href="profile.html"><h4 className="font-semibold text-sm text-black dark:text-white"> James Lewis</h4></a>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                        <a href="profile.html"><h4 className="font-semibold text-sm text-black dark:text-white"> John Michael</h4></a>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                        <a href="profile.html"><h4 className="font-semibold text-sm text-black dark:text-white">  Monroe Parker</h4></a>
                                        <div className="mt-0.5"> Suggested For You </div>
                                    </div>
                                    <button type="button" className="text-sm rounded-full py-1.5 px-4 font-semibold bg-secondery"> Follow </button>
                                </div> 
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                        <a href="profile.html"><h4 className="font-semibold text-sm text-black dark:text-white">  Martin Gray</h4></a>
                                        <div className="mt-0.5"> Suggested For You </div>
                                    </div>
                                    <button type="button" className="text-sm rounded-full py-1.5 px-4 font-semibold bg-secondery"> Follow </button>
                                </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm p-5 px-6 border1 dark:bg-dark2">
                            ...
                            <div className="relative capitalize font-normal text-sm mt-4 mb-2" uk-slider="autoplay: true;finite: true">
                                ...
                                <div className="overflow-hidden uk-slider-container">
                                    ...
                                    <ul className="-ml-2 uk-slider-items w-[calc(100%+0.5rem)]">
                                        ...
                                        <a href="profile.html"> 
                                            <div className="flex flex-col items-center shadow-sm p-2 rounded-xl border1">
                                                ...
                                                <div className="mt-5 text-center w-full">
                                                    <a href="profile.html"> <h5 className="font-semibold"> Martin Gray</h5> </a>
                                        ...
                                        <li className="w-1/2 pr-2">
                                            <div className="flex flex-col items-center shadow-sm p-2 rounded-xl border1">
                                                ...
                                                <div className="mt-5 text-center w-full">
                                                    <a href="profile.html"> <h5 className="font-semibold"> Alexa Park</h5> </a>
                                                    <div className="text-xs text-gray-400 mt-0.5 font-medium"> 12K Followers</div>
                                                    <button type="button" className="bg-secondery block font-semibold mt-4 py-1.5 rounded-lg text-sm w-full border1"> Follow </button>
                                                </div>
                                            </div>
                                        ...
                                        <li className="w-1/2 pr-2">
                                            <div className="flex flex-col items-center shadow-sm p-2 rounded-xl border1">
                                                ...
                                                <div className="mt-5 text-center w-full">
                                                    <a href="profile.html"> <h5 className="font-semibold"> James Lewis</h5> </a>
                                    ...
                                    <button type="button" className="absolute -translate-y-1/2 bg-slate-100 rounded-full top-1/2 -left-4 grid w-9 h-9 place-items-center dark:bg-dark3"  uk-slider-item="previous">                                       
                                      <IoChevronBack className="text-2xl"/>
                                    </button>
                                    <button type="button" className="absolute -right-4 -translate-y-1/2 bg-slate-100 rounded-full top-1/2 grid w-9 h-9 place-items-center dark:bg-dark3" uk-slider-item="next">                                       
                                      <IoChevronForward className="text-2xl"/>
                                    </button>
