export default function Menu() {
    return (
      ...
      >
        <div className="h-20 px-2 flex items-center justify-center">
          <a href="/" id="logo" className="flex items-center gap-3">
            <img
              id="logo__icon"
              src="/assets/images/logo-icon.png"
              alt="Logo Icon"
              className="md:w-8 block shrink-0 uk-animation-scale-up"
            />
            <img
              id="logo__text"
              src="/assets/images/logo.svg"
              alt="Logo"
              className="h-6 ml-1 hidden xl:block dark:!hidden"
            />
            <img
              id="logo__text-dark"
              src="/assets/images/logo-dark.svg"
              alt="Logo Dark"
              className="h-6 ml-1 hidden xl:dark:block"
            />
          </a>
        </div>        
        <div id="sidebar" className="fixed top-0 left-0 z-40 max-md:top-auto max-md:bottom-0">
            <div id="sidebar__inner" className="flex md:flex-col justify-between md:h-screen md:p-2 p-1 transition-all duration-500 bg-white shadow dark:bg-dark2 2xl:w-72 xl:w-60 max-xl:w-[73px] max-md:w-screen max-md:border-t max-md:dark:border-slate-700">
                <div className="flex h-20 px-2 max-md:fixed max-md:top-0 max-md:w-full max-md:bg-white/80 max-md:left-0 max-md:px-4 max-md:h-14 max-md:shadow-sm max-md:dark:bg-slate-900/80 backdrop-blur-xl">
                    <a href="home.html" id="logo" className="flex items-center gap-3">
                        ...
                        <img id="logo__text-dark" src="assets/images/logo-dark.svg" alt="" className="w-full h-6 ml-1 hidden max-xl:hidden max-md:block dark:block" />
                    </a>
                </div>
